...
var botaoParar = document.querySelector('#parar');
botaoIniciar.addEventListener('click', function () {
  return alteraEstado('INICIAR');
});
botaoPausar.addEventListener('click', function () {
  return alteraEstado('PAUSAR');
});
botaoParar.addEventListener('click', function () {
  return alteraEstado('PARAR');
...
setInterval(function () {
  ...
  output.innerHTML = "".concat((contagem / 1000).toFixed(1), " s");
}, 100);
